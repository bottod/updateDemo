...
QT_MOC_LITERAL(5, 47, 15), // "send_now_packet"
QT_MOC_LITERAL(6, 63, 6) // "recall"

    },
    "SocketThread\0send_bar_num\0\0num\0"
    "send_result_num\0send_now_packet\0recall"
};
...
void SocketThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->send_now_packet((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (SocketThread::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketThread::send_now_packet)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void SocketThread::send_now_packet(int _t1, int _t2)
{
